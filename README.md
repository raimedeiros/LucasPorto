...
- **Cache:** ao alterar `style.css` ou `script.js`, aumente o número em `?v=` nos links do `index.html` (ex.: `style.css?v=3`). Sem isso, navegadores podem continuar usando o arquivo antigo e a página aparece com estilos quebrados.
